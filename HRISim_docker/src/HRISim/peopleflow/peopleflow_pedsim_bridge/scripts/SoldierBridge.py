...
from hrisim_util.SoldierAgent import SoldierAgent as Agent  # <--- IMPORT MODIFICATO
        ...
        try:
            ...
            if (self.timeOfDay == constants.TOD.H1.value and not agent.atWork and 
                ...
                if agent.startingTime is None:
                    agent.startingTime = self.elapsedTime + 1
...
if __name__ == '__main__':
    ...
    rospy.logwarn("Soldier Bridge started!") # Aggiunto log per capire che sta partendo
