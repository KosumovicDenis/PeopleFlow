...
def generate_tesi_2_graph():
    ...
    G.add_edge("WP_CENTER", "WP_SAFE", weight=dist(waypoints["WP_CENTER"], waypoints["WP_SAFE"]))
    ...
    print(f"Grafo 'scenario_tesi_2' generato con successo in: {output_file}")

if __name__ == "__main__":
    generate_tesi_2_graph()
